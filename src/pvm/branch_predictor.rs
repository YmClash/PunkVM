...
pub struct HybridPredictor {
    ...
    // Note: BTB supprimé du HybridPredictor - utilise celui du BranchPredictor parent
}
...
impl HybridPredictor {
    pub fn new(local_history_bits: usize, global_history_bits: usize, gshare_table_size: usize) -> Self {
        ...
        Self {
            ...
            // BTB supprimé du HybridPredictor - utilise celui du BranchPredictor parent
        }
    }
...
mod tests {
    ...
    fn test_dynamic_predictor_state_transitions() {
        let mut predictor = BranchPredictor::new(PredictorType::Dynamic); //  HybridPredictor fonctionne aussi sur ce test
        let pc = 0x2000;
    ...
    #[test]
    fn test_alternating_branches_with_hybrid_predictor() {
        let mut predictor = BranchPredictor::new(PredictorType::Hybrid);
